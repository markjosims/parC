...
Copy the following JSON Schemas verbatim into `schemas/`. Do not modify them.

**schemas/MorphemeSequence.json**
[paste MorphemeSequence.json contents]

**schemas/Paradigm.json**
[paste Paradigm.json contents]

**schemas/FeatureMarkers.json**
[paste FeatureMarkers.json contents]

**schemas/Inventory.json**
[paste Inventory.json contents]
