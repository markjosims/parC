...
LEFT_H_RULE_NONVACUOUS = TAG_LEFTH_FOR_DELETION @ DELETOR @ LEFT_H_RULE
LEFT_H_RULE_NONVACUOUS.optimize()
...
FINAL_LOWERING_RULE_NONVACUOUS = TAG_FINAL_LOWERING_FOR_DELETION @ DELETOR @ FINAL_LOWERING_RULE
FINAL_LOWERING_RULE_NONVACUOUS.optimize()
