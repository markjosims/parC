...
Each element of 'combinations' must have all of the specified features as keys, and the values are the possible values features can take on for that set of combinations, or the wildcard operator "*" to indicate all features.
